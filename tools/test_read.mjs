 ...
 *  העימוד נקרא **פעם אחת לכל עמוד**, ⭐ ולפני התיקון עמודים 3–5 נמשכו
 *  עבור המוסד החדש והתוצאה החזירה `ok:true` עם שורות של **שניהם**. */
{
 ...
 *  שלפני התיקון, ⚠️ ומה שנמדד בו הוא שרשור עמודים של שני מוסדות. */
{
