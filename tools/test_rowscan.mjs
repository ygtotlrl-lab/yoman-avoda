...
const APP = {
  ...
  rowClaims: {
    ...
    93: ['המשוב בלחיצה נקבע ולא נירש', 'המשוב בלחיצה נקבע ולא נירש',
      ...
      'המשוב בלחיצה נקבע ולא נירש', 'המשוב בלחיצה נקבע ולא נירש',
      'המשוב בלחיצה נקבע ולא נירש', 'המשוב בלחיצה נקבע ולא נירש'],
    94: ['[token-pattern]', '[token-pattern]', '[token-pattern]', '[token-pattern]',
      '[token-pattern]'],
    95: ['כפתור שכותב מושבת בזמן הכתיבה', 'כפתור שכותב מושבת בזמן הכתיבה',
      'כפתור שכותב מושבת בזמן הכתיבה', 'כפתור שכותב מושבת בזמן הכתיבה',
      'כפתור שכותב מושבת בזמן הכתיבה', 'כפתור שכותב מושבת בזמן הכתיבה'],
    96: ['`toast` — חתימה, גוף ומחלקות', '`toast` — חתימה, גוף ומחלקות',
    ...
    97: ['ליטרל עברי באתר הודעה', 'ליטרל עברי באתר הודעה', 'ליטרל עברי באתר הודעה',
      'ליטרל עברי באתר הודעה', 'ליטרל עברי באתר הודעה', 'ליטרל עברי באתר הודעה',
      'ליטרל עברי באתר הודעה'],
    98: ['ג · פעולה שדורשת רשת'],
    99: ['storage'],
    100: ['פינוי אוטומטי', 'פינוי אוטומטי', 'פינוי אוטומטי', '[ls-quota-derived]',
          '[ls-quota-measured]', '[ls-apps-peers]', '[mirror-evict]', '[child-with-parent]',
          '[mirror-screen-whole]'],
    101: ['שכבת המראה', 'שכבת המראה', 'שכבת המראה', 'שכבת המראה', 'שכבת המראה', 'שכבת המראה',
      'שכבת המראה'],
    102: ['חותמת רעננות נכשלת סגור', 'חותמת רעננות נכשלת סגור', 'kvMeta',
      'חותמת רעננות נכשלת סגור'],
    103: ['פסק זמן אחיד לקריאות רשת'],
    104: ['מאזיני מצב רשת'],
    105: ['פריסה במסכי טלפון וטאבלט', 'פריסה במסכי טלפון וטאבלט', 'פריסה במסכי טלפון וטאבלט',
    ...
    106: ['ערכת נושא — בהיר וכהה', 'ערכת נושא — בהיר וכהה', 'ערכת נושא — בהיר וכהה',
