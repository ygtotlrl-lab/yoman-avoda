...
const APP = {
  ...
  gapRows: [214, 97, 74, 75, 128, 133, 180, 182, 183, 68, 181, 184, 73, 185, 186, 187, 189, 106],
  ...
  tableProbe: {
    ...
    146: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '163|החלפת הקשר מאפסת את כל המצב': 'src',
