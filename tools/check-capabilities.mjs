...
const APP = {
  ...
  gapRows: [94, 72, 73, 124, 129, 175, 177, 178, 66, 176, 179, 71, 180, 181, 182, 184, 103],
  ...
  tableProbe: {
    ...
    142: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '159|החלפת הקשר מאפסת את כל המצב': 'src',
