...
const APP = {
  ...
  writeActs: [],
  writeActsWhy: 'אין ביומן כניסה ואין טבלת משתמשים — ⛔ וכל כתיבה אחרת מקומית-תחילה, ⚠️ ואין מטפל שממתין לרשת',
  ...
  gapRows: [87, 65, 66, 110, 115, 158, 160, 161, 59, 159, 162, 64, 163, 164, 165, 167],
  ...
  tableProbe: {
    ...
    128: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '143|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 165, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
