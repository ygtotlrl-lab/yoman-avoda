...
const APP = {
  ...
  gapRows: [86, 65, 66, 112, 117, 160, 162, 163, 59, 161, 164, 64, 165, 166, 167, 169, 93],
  ...
  tableProbe: {
    ...
    130: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '145|החלפת הקשר מאפסת את כל המצב': 'src',
