...
const APP = {
  ...
  gapRows: [221, 98, 74, 75, 131, 136, 183, 185, 186, 68, 184, 187, 73, 188, 189, 190, 192, 107],
  ...
  tableProbe: {
    ...
    149: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '166|החלפת הקשר מאפסת את כל המצב': 'src',
