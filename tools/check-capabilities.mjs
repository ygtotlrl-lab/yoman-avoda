...
const APP = {
  ...
  gapRows: [92, 70, 71, 122, 127, 173, 175, 176, 64, 174, 177, 69, 178, 179, 180, 182, 101],
  ...
  tableProbe: {
    ...
    140: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '157|החלפת הקשר מאפסת את כל המצב': 'src',
