...
const APP = {
  ...
  gapRows: [229, 100, 73, 74, 137, 143, 191, 193, 194, 67, 192, 195, 72, 196, 197, 198, 200, 111],
  ...
  tableProbe: {
    ...
    156: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '173|החלפת הקשר מאפסת את כל המצב': 'src',
