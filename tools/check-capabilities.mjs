...
const APP = {
  ...
  gapRows: [87, 65, 66, 114, 119, 163, 165, 166, 59, 164, 167, 64, 168, 169, 170, 172, 95],
  ...
  tableProbe: {
    ...
    132: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '148|החלפת הקשר מאפסת את כל המצב': 'src',
