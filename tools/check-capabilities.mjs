...
const APP = {
  ...
  gapRows: [91, 69, 70, 120, 125, 171, 173, 174, 63, 172, 175, 68, 176, 177, 178, 180, 100],
  ...
  tableProbe: {
    ...
    138: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '155|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 84, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
