...
const APP = {
  ...
  gapRows: [223, 98, 72, 73, 134, 139, 187, 189, 190, 66, 188, 191, 71, 192, 193, 194, 196, 108],
  ...
  tableProbe: {
    ...
    152: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '169|החלפת הקשר מאפסת את כל המצב': 'src',
