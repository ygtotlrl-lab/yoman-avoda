...
const APP = {
  ...
  skipCaps: ['lock', 'sess', 'writeUser', 'isAdmin', 'mirror'],
  ...
  gapRows: [86, 65, 66, 109, 114, 157, 159, 160, 59, 158, 161, 64, 162, 163, 164, 166],
  ...
  tableProbe: {
    ...
    127: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '142|החלפת הקשר מאפסת את כל המצב': 'src',
