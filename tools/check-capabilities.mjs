...
const APP = {
  ...
  gapRows: [96, 74, 75, 127, 132, 179, 181, 182, 68, 180, 183, 73, 184, 185, 186, 188, 105],
  ...
  tableProbe: {
    ...
    145: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '162|החלפת הקשר מאפסת את כל המצב': 'src',
