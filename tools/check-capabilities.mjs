...
const APP = {
  ...
  gapRows: [225, 99, 73, 74, 135, 141, 189, 191, 192, 67, 190, 193, 72, 194, 195, 196, 198, 109],
  ...
  tableProbe: {
    ...
    154: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '171|החלפת הקשר מאפסת את כל המצב': 'src',
