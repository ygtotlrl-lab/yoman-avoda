...
const APP = {
  ...
  gapRows: [89, 67, 68, 117, 122, 168, 170, 171, 61, 169, 172, 66, 173, 174, 175, 177, 98],
  ...
  tableProbe: {
    ...
    135: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '152|החלפת הקשר מאפסת את כל המצב': 'src',
