...
const APP = {
  ...
  gapRows: [218, 97, 74, 75, 130, 135, 182, 184, 185, 68, 183, 186, 73, 187, 188, 189, 191, 106],
  ...
  tableProbe: {
    ...
    148: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '165|החלפת הקשר מאפסת את כל המצב': 'src',
