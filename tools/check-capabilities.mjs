...
const APP = {
  ...
  gapRows: [84, 65, 66, 107, 112, 154, 156, 157, 59, 155, 158, 64, 159, 160, 161, 163],
  ...
  tableProbe: {
    ...
    125: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '140|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 153, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
