...
const APP = {
  ...
  skipCaps: ['lock', 'sess', 'writeUser', 'isAdmin'],
  ...
  gapRows: [64, 65, 105, 110, 150, 152, 153, 58, 151, 154, 63, 155, 156, 157, 159],
  ...
  tableProbe: {
    ...
    123: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '137|החלפת הקשר מאפסת את כל המצב': 'src',
