...
const APP = {
  ...
  gapRows: [84, 65, 66, 107, 112, 153, 155, 156, 59, 154, 157, 64, 158, 159, 160, 162],
  ...
  probeInput: {
    ...
    '139|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 152, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
