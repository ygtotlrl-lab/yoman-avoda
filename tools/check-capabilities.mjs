...
const APP = {
  ...
  gapRows: [90, 68, 69, 118, 123, 169, 171, 172, 62, 170, 173, 67, 174, 175, 176, 178, 99],
  ...
  tableProbe: {
    ...
    136: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '153|החלפת הקשר מאפסת את כל המצב': 'src',
