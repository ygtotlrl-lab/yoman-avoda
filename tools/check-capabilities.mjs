...
const APP = {
  ...
  gapRows: [230, 101, 74, 75, 195, 196, 194, 197, 198, 200, 202, 112],
  ...
  migrateKeep: {
    migratePrefixKeys: 'הגירת התחילית מ-`tb_` ל-`ya_` (סבב 148) — ⚠️ התור שלא נדחף וזהות המכשיר נושאים במכשיר שלא נטען מאז את השם הישן, ⛔ ולתור אין מקור שני בענן: ⭐ הסרתה מאבדת אותו לנצח',
    migrateLegacyLsKeys: 'מפתחות שקדמו לרב-הדיירות (סבב 13) — ⚠️ ההגירה ממזגת ומאמתת פריט-פריט, ⛔ ומכשיר שלא נטען מאז מחזיק בהם את הנתון היחיד שלו: ⭐ הסרתה מאבדת אותו לנצח',
  },
