...
const APP = {
  ...
  gapRows: [217, 97, 74, 75, 129, 134, 181, 183, 184, 68, 182, 185, 73, 186, 187, 188, 190, 106],
  ...
  tableProbe: {
    ...
    147: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '164|החלפת הקשר מאפסת את כל המצב': 'src',
