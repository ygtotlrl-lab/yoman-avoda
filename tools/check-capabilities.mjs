...
const APP = {
  ...
  gapRows: [228, 101, 74, 75, 138, 144, 192, 194, 195, 68, 193, 196, 73, 197, 198, 199, 201, 112],
  ...
  tableProbe: {
    ...
    157: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '174|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 90, app: 1, appWhy: 'מנוע התאריך העברי — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
