...
const APP = {
  ...
  scanKind: {
    ...
    'test_archive': 'raw — מודד מפתחות ארכיון שחיים כמחרוזות',
    ...
    'test_ids_yoman': 'raw — מודד מפתחות מיזוג שחיים כמחרוזות',
    ...
    'test_share': 'raw — מודד את מסלול השיתוף ואת שמות הקבצים שבו',
    ...
    'test_stage_b': 'raw — מריץ את שלב ב בארגז חול',
    'test_unify': 'raw — מודד מפתחות שריד שחיים כמחרוזות',
    'test_wiring': 'raw — מודד חיווט `data-act` שחי בתגיות ובמחרוזות',
    'test_yeshiva': 'raw — מריץ את החלפת המוסד בארגז חול',
