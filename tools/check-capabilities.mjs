...
const APP = {
  ...
  gapRows: [224, 99, 73, 74, 135, 140, 188, 190, 191, 67, 189, 192, 72, 193, 194, 195, 197, 109],
  ...
  tableProbe: {
    ...
    153: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '170|החלפת הקשר מאפסת את כל המצב': 'src',
