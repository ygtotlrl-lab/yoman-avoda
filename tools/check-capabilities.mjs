...
const APP = {
  ...
  gapRows: [88, 66, 67, 115, 120, 165, 167, 168, 60, 166, 169, 65, 170, 171, 172, 174, 96],
  ...
  tableProbe: {
    ...
    133: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '150|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 83, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
