...
const APP = {
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [59, 60, 98, 103, 141, 143, 145, 146, 147, 148, 149, 151],
  ...
  rowsLayerFns: {},
  fullPullAllow: {},
  /*  ⛔ מיזוג בצורת מפה — ⚠️ `SUBS` היא מפת מפתחות ומשימה שלמה יורדת ממנה,
   *  ⛔ ולכן היא ממוזגת פר-מפתח ⛔ ולא באיחוד: ⭐ ובכל הריפו זה המקום היחיד.
   */
  keyMaps: ['mergeSubs'],
