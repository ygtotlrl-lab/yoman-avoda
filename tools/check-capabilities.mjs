...
const APP = {
  ...
  gapRows: [227, 99, 72, 73, 136, 142, 190, 192, 193, 66, 191, 194, 71, 195, 196, 197, 199, 110],
  ...
  tableProbe: {
    ...
    155: (c) => c.hasCode(/YA_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '172|החלפת הקשר מאפסת את כל המצב': 'src',
