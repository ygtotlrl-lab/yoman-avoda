...
const APP = {
  ...
  gapRows: [83, 64, 65, 106, 111, 151, 153, 154, 58, 152, 155, 63, 156, 157, 158, 160],
  ...
  tableProbe: {
    ...
    124: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '138|החלפת הקשר מאפסת את כל המצב': 'src',
