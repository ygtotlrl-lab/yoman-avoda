...
const APP = {
  ...
  gapRows: [93, 71, 72, 123, 128, 174, 176, 177, 65, 175, 178, 70, 179, 180, 181, 183, 102],
  ...
  tableProbe: {
    ...
    141: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '158|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 84, app: 1, appWhy: 'מנוע התאריך העברי — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
