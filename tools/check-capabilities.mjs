...
const APP = {
  ...
  gapRows: [86, 65, 66, 111, 116, 159, 161, 162, 59, 160, 163, 64, 164, 165, 166, 168, 92],
  ...
  tableProbe: {
    ...
    129: (c) => c.hasCode(/TB_KV_LEGACY_WRITE\s*=\s*false/),
  },
  ...
  probeInput: {
    ...
    '144|החלפת הקשר מאפסת את כל המצב': 'src',
...
const FLOOR = { shared: 81, app: 2, appWhy: 'מנוע התאריך העברי ושער מצב הרשת — ואין כאן כניסה ואין שכבת מראה' };
/* ⚠️ סוף פר-אפליקציה */
