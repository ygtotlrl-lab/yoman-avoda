...
const APP = {
  ...
  dbTables: ['sh_backup', 'tb_kv_ramataviv', 'tb_kv_rishon', 'sh_sync_log', 'tb_entries'],
  ...
  dbDyn: {
    eraTbl:   { tables: ['tb_kv_rishon', 'tb_kv_ramataviv'],
    ...
    's.table': { tables: ['tb_kv_rishon', 'tb_kv_ramataviv'],
