 ...
 *  הקוד: ⭐ נמדד `test_rulesdocs` 102 שניות ושער המטריצה 67, ⛔ והסט
 *  כולו נעצר על שער אחד.
 *
 *  **מה יישבר בלעדיו:** ⛔ הבריכה מריצה תהליך לכל ריפו, ⚠️ ושער שאורכו
 ...
 *  שהוא מפעיל ממוטט ב-`test_matrix_doc`, שהוא היחיד שמהפך תאים.
