...
const APP = {
  ...
  rules: [
    ...
    ['sw',   "indexOf\\('yoman-avoda-'\\)\\s*===\\s*0", true,
             "sw.js: ניקוי מטמון לפי הקידומת 'yoman-avoda-' בלבד"],
  ...
  gates: ['check-structure.mjs', 'check-status-area.mjs', 'check-docs.mjs',
          ...
          'test_round37_merge_pending.mjs', 'test_round37_matrix.mjs', 'test_round37_ids.mjs', 'test_round38_ids_yoman.mjs'],
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
