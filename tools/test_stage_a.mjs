...
const START = '/* ═══ גיבוי יומי ויומן פעולות — מודול משותף';
...
/*  ⛔ המודול המשותף שהגיבוי נשען עליו — ⚠️ העימוד עבר לשם. */
const PAGED_SRC = (() => {
...
/* ── הרתמה ─────────────────────────────────────────────────────────────── */
/* ⭐ יום חדש — ⛔ מחיקת הדגל הגלובלי לבדה כבר אינה מספיקה:
   לכל מקור יש **דגל-יום משלו** (`bk_day_<מפתח>`), וזה מה שמונע
...
function makeEnv(opts = {}) {
  ...
  env.client = {
    from(table) {
      ...
      const api = {
        /*  ⛔ העימוד וספירת השרת נכנסו לרתמה — ⚠️ הגיבוי קורא
        ...
        // תמיכת מחיקה — מדיניות השמירה: delete().in().lt().select()
  ...
  const sandbox = {
    ...
    /*  ⛔ פסק הזמן מוחלף בזהות — ⚠️ הרתמה אינה מודדת רשת,
...
/* ══════════════════════════════════════════════════════════════════════════
   3ב · ⭐ כשל חלקי מדווח ⛔ אך אינו משתק
   ══════════════════════════════════════════════════════════════════════════
...
async function t13() {
  ...
  /*  ⛔ מקור-טבלה נכתב מעכשיו תחת מפתח העוגן — ⚠️ העותק הראשון
...
/* ══════════════════════════════════════════════════════════════════════════
   14 · מוטציות — שלוש הדרישות של מדיניות השמירה
   ══════════════════════════════════════════════════════════════════════════ */
async function t14() {
  const OLD31 = new Date(Date.now() - 31 * 86400000).toISOString();
