...
export const DB_SCHEMA = [
    ...
    { p: 'kupa',   t: 'kp_settings',        c: 'key,value,updated_at,client_id,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_years',           c: 'client_id,hebrew_year,pleziash,chumash_opening_balance,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_months',          c: 'client_id,hebrew_year,name,ordinal,start_date,end_date,closed_at,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_standing_orders', c: 'client_id,name,amount,day_of_month,method,category,active,valid_from_month,valid_to_month,supersedes_id,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_so_instances',    c: 'client_id,standing_order_client_id,month_client_id,amount,status,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_entries',         c: 'client_id,month_client_id,type,amount,description,entry_date,method,category,source,verified,so_instance_client_id,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_lookups',         c: 'client_id,kind,label,sort,created_at,updated_at,deleted,deleted_at,deleted_by' },
