...
export const DB_SCHEMA = [
    ...
    { p: 'kupa',   t: 'kp_pledges',         c: 'client_id,hebrew_year,pledge,chumash_opening_balance,created_at,updated_at,deleted,deleted_at,deleted_by' },
    ...
    { p: 'kupa',   t: 'kp_so_instances',    c: 'client_id,standing_order_client_id,month_key,amount,status,created_at,updated_at,deleted,deleted_at,deleted_by' },
    { p: 'kupa',   t: 'kp_entries',         c: 'client_id,type,amount,description,entry_date,method,category,source,verified,so_instance_client_id,created_at,updated_at,deleted,deleted_at,deleted_by' },
