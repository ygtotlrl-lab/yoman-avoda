...
/* ═══ מסירת התצורה — מודול משותף ════════════════════════════════════════
   ...
   ⛔ **והמסירה בשומרי קריאה (`get`)** ⛔ ולא בערכים — ⚠️ חלק מהתצורה
      מוגדר ב-`index.html` אחרי הייבוא, ⭐ ושומר קורא אותו בזמן הקריאה.
...
/* ═══ ערך מפתח-ערך — מודול משותף ════════════════════════════════════════
   ⛔ «אין ערך» ו«ערך פגום» אינן אותה תשובה — ⚠️ «נכשל» לשתיהן שולח את
      המשתמש לחפש רשת שלא נפלה.
   ⛔ ולכן `null` הוא ערך שאינו קיים ⛔ ואינו כשל, ⚠️ וערך שאינו JSON הוא כשל
      שנוקב בשם המפתח.
   ⛔ והנוסח אחד — ⚠️ שני נוסחים לאותה תקלה הם שני חיפושים.
   ═══════════════════════════════════════════════════════════════════════ */
