/* ═══ core/storage.js — האחסון המקומי ═══════════════════════════════════
   ⭐ הכתיבה לדיסק, הפינוי, החלון החם ושכבת המראה.
   השורות: «אסטרטגיית `localStorage`» · «`hw` — חלון חם» · «שכבת המראה»
...
export { MIRROR, MSG_LS_FULL, hwBoot, hwDiskFilter, hwForget, hwNoteCloud,
         hwPastLoad, lsBoot, lsClearHorizons, lsGet, lsGuardToast,
         lsHorizonRelease, lsLog, lsRemove, lsSet, lsSetArray, lsSetRaw,
         mirrorBoot, mirrorKey, mirrorLoadOne, mirrorSave, mirrorTables,
         mirrorWrite };
